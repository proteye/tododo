...
class AesHelper {
  ...
  static Uint8List encryptBytes(Uint8List key, Uint8List textBytes,
      {String mode = CBC_MODE}) {
    Uint8List derivedKey = deriveKey(key);
    KeyParameter keyParam = new KeyParameter(derivedKey);
    BlockCipher aes = new AESFastEngine();
    ...
    return cipherIvBytes;
  }

  static Uint8List decryptBytes(Uint8List key, Uint8List cipherIvBytes,
      {String mode = CBC_MODE}) {
    Uint8List derivedKey = deriveKey(key);
    KeyParameter keyParam = new KeyParameter(derivedKey);
    BlockCipher aes = new AESFastEngine();
